...
enum TaskState<TResult> {
    ...
    static func fromClosure(_ closure: @noescape () throws -> TResult) -> TaskState {
        do {
...
public final class Task<TResult> {
    ...
    private let synchronizationQueue = DispatchQueue(label: "com.bolts.task", attributes: .concurrent)
